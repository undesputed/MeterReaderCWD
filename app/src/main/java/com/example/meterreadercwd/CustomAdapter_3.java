...
public class CustomAdapter_3 extends BaseAdapter implements Filterable {
    Context context;
    ...
    public CustomAdapter_3(Context context, ArrayList<Applicant_Helper>list) {
        super();
    ...
    public Filter getFilter() {
        ...
        if(filter == null)
        {
            filter=new CustomAdapter_3.CustomFilter();
        }
